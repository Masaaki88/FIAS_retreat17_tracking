...
if __name__ == '__main__':
    frontal_faces_cascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml')
    profile_faces_cascade = cv2.CascadeClassifier('haarcascade_profileface.xml')
